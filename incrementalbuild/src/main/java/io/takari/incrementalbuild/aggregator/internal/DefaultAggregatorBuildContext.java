...
public class DefaultAggregatorBuildContext extends AbstractBuildContext implements AggregatorBuildContext {
    ...
    public DefaultAggregatorBuildContext(
            Workspace workspace,
            File stateFile,
    ...
    private Map<String, Serializable> glean(Collection<File> inputs, MetadataAggregator<? extends Serializable> gleaner)
            throws IOException {
    ...
    public boolean aggregateIfNecessary(Collection<File> inputs, File outputFile, MetadataAggregator<?> aggregator)
            throws IOException {
        outputFile = registerOutput(outputFile);
        associate(inputs, outputFile);
    ...
    private void aggregate(MetadataAggregator<?> aggregator, DefaultOutput output, Map<String, Serializable> metadata)
            throws IOException {
    ...
    @Override
    public Collection<DefaultResourceMetadata<File>> registerInputs(
