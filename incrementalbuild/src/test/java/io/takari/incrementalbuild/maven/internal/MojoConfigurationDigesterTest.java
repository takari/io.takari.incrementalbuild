...
public class MojoConfigurationDigesterTest {
    ...
    public void testArtifactRepositoryCollection() throws Exception {
        Map<String, Serializable> digest = digest(newParameter("remotes", "${project.remoteArtifactRepositories}"));
    ...
    public void testInheretedFields() throws Exception {
        Map<String, Serializable> digest = digest(ExtendedDigestedMojo.class, newParameter("string", "string"));
        Assert.assertEquals("string", digest.get("mojo.parameter.string"));
    }
}
