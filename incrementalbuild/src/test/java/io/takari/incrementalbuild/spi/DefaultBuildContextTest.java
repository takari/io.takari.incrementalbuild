...
public class DefaultBuildContextTest extends AbstractBuildContextTest {
    ...
    public void testCreateStateParentDirectory() throws Exception {
        ...
        TestBuildContext context = new TestBuildContext(stateFile, Collections.<String, Serializable>emptyMap());
        context.commit();
    ...
    public void testRegisterAndProcessInputs() throws Exception {
        ...
        TestBuildContext context = newBuildContext();
        List<DefaultResource<File>> inputs = toList(context.registerAndProcessInputs(temp.getRoot(), includes, null));
    ...
    public void testStateSerialization_useTCCL() throws Exception {
        ...
        try {
            ...
            Assert.assertNotNull(context.getAttribute(context.registerInput(inputFile), "dummy", Serializable.class));
            // no commit
        } finally {
    ...
    public void testConfigurationChange() throws Exception {
        ...
        context = newBuildContext(Collections.<String, Serializable>singletonMap("config", "parameter"));
        DefaultResourceMetadata<File> metadata = context.registerInput(inputFile);
    ...
    public void testRegisterInputs_includes_excludes() throws Exception {
        ...
        actual = toFileList(context.registerInputs(temp.getRoot(), Arrays.asList("**"), Arrays.asList("**/*.log")));
        assertIncludedPaths(Arrays.asList(f1, f2), actual);
    }
    ...
    public void testRegisterInputs_directoryMatching() throws Exception {
        ...
        actual = toFileList(context.registerInputs(temp.getRoot(), Arrays.asList("folder/**/*.txt"), null));
    ...
    private static void assertIncludedPaths(Collection<File> expected, Collection<File> actual) throws IOException {
    ...
    public void testInputDirectoryDoesNotExist() throws Exception {
        ...
        TestBuildContext context = newBuildContext();
        Assert.assertEquals(
                0, toList(context.registerInputs(basedir, null, null)).size());
        Assert.assertEquals(
                0, toList(context.registerAndProcessInputs(basedir, null, null)).size());
    }
