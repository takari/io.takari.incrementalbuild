...
public class DefaultBuildContextStateTest {
    ...
    public void testStateDoesNotExist() throws Exception {
        DefaultBuildContextState state = DefaultBuildContextState.loadFrom(new File(temp.getRoot(), "does-not-exist"));
    ...
    public void testEmptyState() throws Exception {
        Assert.assertTrue(
                DefaultBuildContextState.loadFrom(temp.newFile()).configuration.isEmpty());
    }
    ...
    public void testCorruptedState() throws Exception {
        ...
        Assert.assertTrue(
                DefaultBuildContextState.loadFrom(corrupted).configuration.isEmpty());
    }
    ...
    public void testIncompatibleState() throws Exception {
        ...
        oos.close();
        Assert.assertTrue(
                DefaultBuildContextState.loadFrom(incompatible).configuration.isEmpty());
    }
}
