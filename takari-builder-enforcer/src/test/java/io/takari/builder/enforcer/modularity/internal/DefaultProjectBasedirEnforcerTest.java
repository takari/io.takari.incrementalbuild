...
public class DefaultProjectBasedirEnforcerTest {
  ...
  public void testRootMatch() throws Exception {
    ...
    util = utilBuilder().withReactorRoot(basedir).withAllowBreakingExceptionsProperty(true)
        .withAllowReadByDefaultProperty(true).withAllowWriteByDefaultProperty(true).build();
  ...
  public void testBasicWriteToProjectNonTarget() throws Exception {
    ...
    util = utilBuilder().withReactorRoot(basedir).withAllowBreakingExceptionsProperty(true).build();

    util.setupContextForRootProject();

    assertFalse(
        util.getProjectContext().checkWrite(new File(basedir, "text.txt").getAbsolutePath()));
  }
  ...
  public void testEnforceTempAccess() throws Exception {
    ...
    assertTrue(util.getProjectContext().checkRead(Files.newTemporaryFile().getAbsolutePath()));
  }
  ...
  public void testEnforceWithBadException() throws Exception {
    ...
    util = utilBuilder().withReadException("*", "/stuff/").withReactorRoot(basedir)
        .withAllowBreakingExceptionsProperty(true).build();

    util.setupContextForRootProject();

    assertFalse(
        util.getProjectContext().checkWrite(new File(basedir, "stuff/text.txt").getAbsolutePath()));
  }
  ...
  public void testEnforceOnCommandWithException() throws Exception {
    ...
    util = utilBuilder().withReactorRoot(basedir).withExecException("*", "git")
        .withAllowBreakingExceptionsProperty(true).build();
  ...
  public void testDependencyALLAllowsParentsAsWell() throws Exception {
    ...
    util = utilBuilder().withReactorRoot(basedir).withReadException("*", "${dependency.?ALL}/")
        .withDependentProject(basedir, module).withAllowBreakingExceptionsProperty(true).build();
  ...
  public void testEnforceReadFromNonDependencyReactor() throws Exception {
    ...
    util = utilBuilder().withReactorRoot(basedir)
        // this rule should be ignored since this is a breaking rule
        .withReadException("m2", "/m1/text.txt").withDependentProject(basedir, module1)
        .withDependentProject(basedir, module2, "m2").build();
  ...
  public void testEnforceReadFromNonDependencyReactorWithBadException() throws Exception {
    ...
    util = utilBuilder().withReactorRoot(basedir).withAllowBreakingExceptionsProperty(true)
        ...
        .withReadException("m2", "${dependency.m1}/text.txt").withDependentProject(basedir, module1)
        .withDependentProject(basedir, module2, "m2").build();
  ...
  public void testEnforceReadFromDependencyReactor() throws Exception {
    ...
    util = utilBuilder().withReactorRoot(basedir).withAllowBreakingExceptionsProperty(true)
        ...
        .withDependentProject(basedir, module1, "m1").withDependentProject(module1, module2, "m2")
        .build();
  ...
  public void testEnforceReadFromAllDependencyReactor() throws Exception {
    ...
    util = utilBuilder().withReactorRoot(basedir).withAllowBreakingExceptionsProperty(true)
        .withReadException("m2", "${dependency.?ALL}/").withDependentProject(basedir, module1, "m1")
        .withDependentProject(module1, module2, "m2").build();
  ...
  public void testEnforceReadFromNonDependencyReactorPointingAtRoot() throws Exception {
    ...
    util = utilBuilder().withReactorRoot(basedir).withAllowBreakingExceptionsProperty(true)
        .withReadException("m2", "/").withDependentProject(basedir, module1, "m1")
        .withDependentProject(basedir, module2, "m2").build();
  ...
  public void testEnforceWithProjectExecption() throws Exception {
    ...
    util = utilBuilder().withReactorRoot(basedir).withAllowBreakingExceptionsProperty(true)
        .withProjectExclusion("m2").withDependentProject(basedir, module1, "m1")
        .withDependentProject(basedir, module2, "m2").build();
