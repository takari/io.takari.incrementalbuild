...
public class DefaultProjectBasedirEnforcerTest {
    ...
    public void testBasicWriteToProjectNonTarget() throws Exception {
        ...
        assertFalse(util.getProjectContext().checkWrite(new File(basedir, "text.txt").getAbsolutePath()));
    }
    ...
    public void testEnforceWithBadException() throws Exception {
        ...
        assertFalse(util.getProjectContext().checkWrite(new File(basedir, "stuff/text.txt").getAbsolutePath()));
    }
