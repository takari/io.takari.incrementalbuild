...
public class EnforcerConfigTest {
  ...
  public void testWildcardForSingleBuilder() throws Exception {
    ...
    config = EnforcerConfig.builder().enforce(true).withReadException("*", "/some/file")
        .withReadException("project", "/some/other/file").build();
  ...
  public void testNetworkAccess() throws Exception {
    config = EnforcerConfig.builder().enforce(true).withNetworkException("project").build();
  ...
  public void testNoNetworkAccess() throws Exception {
    config = EnforcerConfig.builder().enforce(true).withNetworkException("not-project").build();
  ...
  public void testNoExclusion() throws Exception {
    config = EnforcerConfig.builder().enforce(true).withExclusion("not-project").build();
  ...
  public void testMixed() throws Exception {
    config = EnforcerConfig.builder().enforce(true).withReadException("project", "/some/file")
        .withWriteException("project", "/not/checking").withWriteException("other", "/some/other")
        .withWriteException("other", "/additional/one").withNetworkException("project").build();
  ...
  public void testHasEntriesFor() throws Exception {
    config = EnforcerConfig.builder().enforce(true).withReadException("1", "/some/file")
        .withWriteException("2", "/not/checking").withExecException("3", "/some/other")
        .withNetworkException("4").withExclusion("5").withExecException("*", "git").build();
  ...
  public void testFileParsing() throws Exception {
    ...
    String whitelist = new StringBuilder().append("# enforce\n").append("1 R /file1\n")
        .append("2 RT /file2\n").append("3 W /file3\n").append("4 E git\n").append("5 N\n")
        .append("6 P\n").append("* R some/other\n").toString();
