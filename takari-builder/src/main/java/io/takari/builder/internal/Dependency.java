...
public class Dependency {
    ...
    static Dependency fromConfig(Xpp3Dom config) {
      ...
      return new Dependency(groupId.getValue(), artifactId.getValue(), 
          classifier != null ? classifier.getValue() : null);
    }
     ...
     *  If the classifier is empty / undefined, return the first matching artifact.
     *  If the classifier is defined, return only an artifact matching the specified classifier. **/
