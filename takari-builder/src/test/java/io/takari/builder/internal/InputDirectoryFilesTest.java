...
public class InputDirectoryFilesTest {
    ...
    static class _CompileSourceRoots {
        ...
        @InputDirectoryFiles(
                filesRequired = true,
                value = {TEST_SOURCE_ROOTS_EXPR, "/bad"},
                includes = "**/*")
    ...
    public void testTestCompileSourceRootsExtraParams() throws Exception {
        ...
        thrown.expectMessage(
                String.format("%s can not have other values provided along with it", TEST_SOURCE_ROOTS_EXPR));
    ...
    public void testConfiguredCompileSourceRootsFails() throws Exception {
        thrown.expect(InvalidConfigurationException.class);
        thrown.expectMessage(
                String.format("_Data.files: %s expression is not allowed in configuration", SOURCE_ROOTS_EXPR));
        ...
        builder(temp.getRoot()) //
                ...
                .withConfigurationXml(
                        String.format("<files><files><location>%s</location></files></files>", SOURCE_ROOTS_EXPR))
