...
public class FileInputTest {
    ...
    public void testListFileOptional_allFilesDoNotExist() throws Exception {
        ...
        assertEquals(Arrays.asList(new File(basedir, "1.txt"), new File(basedir, "2.txt")), value.value());
    }
    ...
    public void testTestCompileSourceRootsAsInputFileFails() throws Exception {
        ...
        thrown.expect(InvalidConfigurationException.class);
        thrown.expectMessage(String.format(
                "_CompileSourceRoots.thisToo.thisToo: %s expression is not allowed here", TEST_SOURCE_ROOTS_EXPR));
