...
public class BuilderInputsTest {
    ...
    public void testNoParameterDigest() throws Exception {
        ...
        Digest emtydigest = BuilderExecutionState.load(new File(temp.getRoot(), "nosuchfile").toPath()).inputsDigest;
    ...
    public void testDefinedPropertyDefaultValue() throws Exception {
        ...
        assertEquals(
                propertyValue,
                builder()
                        .withProperty("defaultProperty", propertyValue)
                        .build(_Defaults.class, "defaultString")
                        .value());
    }
