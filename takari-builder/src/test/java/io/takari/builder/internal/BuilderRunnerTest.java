...
public class BuilderRunnerTest {
    ...
    public void testBuilderStaticInitializationEnforcement() throws Exception {
        ...
        BuilderExecution.builderExecution(tempdir, StaticInitializationBuilder.class)
                .execute();
    }
    ...
    public void testInputAsOutput() throws Exception {
        ...
        EnforcerConfig enforcerConfig = EnforcerConfig.builder()
                .enforce(true)
                .withReadAndTrackException("input-output", relpath)
                .build();
        ...
        assertThat(readFile(file))
                .as("File should exist and have been written to")
                .isEqualTo("2");
    ...
    public void testUntrackedRead() throws Exception {
        ...
        EnforcerConfig enforcerConfig = EnforcerConfig.builder()
                .enforce(true)
                .withReadException("untracked-read", "**/b")
                .build();
        ...
        assertThat(UntrackedReadBuilder.COUNTER.get())
                .as("File should have been read")
                .isEqualTo(1);
        ...
        assertThat(UntrackedReadBuilder.COUNTER.get())
                .as("Counter should not have been incremented")
                .isEqualTo(1);
    }
    ...
    public void testSystemProperties() throws Exception {
        ...
        builderExecution(SystemPropertiesBuilder.class)
                .withStateFile(stateFile) //
                .execute();
    ...
    public void testGeneratedResources() throws Exception {
        ...
        BuilderExecution.builderExecution(basedir, GeneratedResourcesBuilder.class) //
                ...
                .assertProjectResources(
                        new ResourceRoot(
                                new File(basedir, "main").getAbsolutePath(), ResourceType.MAIN, includes, excludes),
                        new ResourceRoot(
                                new File(basedir, "test").getAbsolutePath(),
                                ResourceType.TEST,
                                new ArrayList<>(),
                                new ArrayList<>())) //
    ...
    public void testCreateDirectoriesAndFiles() throws Exception {
        ...
        InternalBuilderExecution.builderExecution(basedir, CreateDirectoriesAndFilesBuilder.class) //
                ...
                .execute()
                .assertOutputFiles(basedir, "target/dir2/file");
        ...
        InternalBuilderExecution.builderExecution(basedir, CreateDirectoriesAndFilesBuilder.class) //
                ...
                .withConfiguration("directories", ImmutableList.of("dir1")) //
                .execute()
                .assertOutputFiles(basedir, new String[0]);
    ...
    public void testDirectoryCleanup_unrelatedFilesPresent() throws Exception {
        ...
        InternalBuilderExecution.builderExecution(basedir, CreateDirectoriesAndFilesBuilder.class) //
                ...
                .execute()
                .assertOutputFiles(basedir, "target/dir/file");
        ...
        InternalBuilderExecution.builderExecution(basedir, CreateDirectoriesAndFilesBuilder.class) //
                ...
                .execute()
                .assertOutputFiles(basedir, "target/file");
    ...
    public void testCompileSourceRootParsing() throws Exception {
        ...
        BuilderExecution.builderExecution(basedir, CompileSourceRootsBuilder.class)
                .withParameterValue("expectedMain", main)
                .withParameterValue("expectedTest", test)
                .withCompileSourceRoot(main)
                .withTestCompileSourceRoot(test)
                .execute();
    }
    ...
    public void testSourceModeDependenciesAllowedInList() throws Exception {
        ...
        BuilderExecution.builderExecution(basedir, SourceModeDependenciesBuilder.class)
                .withDependency("g:a:c", dep)
                .execute();
    }
    ...
    public void testSourceModeDependenciesAllowedInMap() throws Exception {
        ...
        BuilderExecution.builderExecution(basedir, SourceModeDependencyMapBuilder.class)
                .withDependency("g:a:c", dep)
                .execute();
    }
