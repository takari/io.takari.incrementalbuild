...
public class BuilderRunnerTest {
  ...
  public void testUntrackedRead() throws Exception {
    ...
    EnforcerConfig enforcerConfig =
        EnforcerConfig.builder().enforce(true).withReadException("untracked-read", "**/b").build();
    ...
    assertThat(UntrackedReadBuilder.COUNTER.get()).as("Counter should not have been incremented")
        .isEqualTo(1);
  }
  ...
  public void testCompileSourceRootParsing() throws Exception {
    ...
    BuilderExecution.builderExecution(basedir, CompileSourceRootsBuilder.class)
        .withParameterValue("expectedMain", main).withParameterValue("expectedTest", test)
        .withCompileSourceRoot(main).withTestCompileSourceRoot(test).execute();
  }
  ...
  public void testSourceModeDependenciesAllowedInList() throws Exception {
    ...
    BuilderExecution.builderExecution(basedir, SourceModeDependenciesBuilder.class)
        .withDependency("g:a:c", dep).execute();
  }
