...
public class DependenciesInputTest {
  ...
  public void testDigest() throws Exception {
    ...
    Digest metadataDigest =
        digest(new DependencyValue(IArtifactMetadata.class, newArtifact("g:a"), path));
  ...
  public void testPathDependencyInput_directory() throws Exception {
    ...
    assertThat(inputs.getInputFiles()).contains(dirDep.getCanonicalFile().toPath().resolve("file"),
