...
public class BuilderMethodTest {
  ...
  public void testFindBuilderMethod() throws Exception {
    ...
    assertEquals(String.format("Expected to find %s builder method", METHOD_NAME), expectedMethod,
        actualMethod);
  }
  ...
  public void testInaccessibleType() throws Exception {
    ...
    Method method =
        getBuilderMethodForGoal(builderType, "inaccessible", BuilderExecutionException::new);
