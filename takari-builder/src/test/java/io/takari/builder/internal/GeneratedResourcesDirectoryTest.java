...
public class GeneratedResourcesDirectoryTest {
  ...
  public void testConfigurationOverrides() throws Exception {
    ...
    assertValue(value, new File(basedir, "config"), "[**/*.default.include]",
        "[**/*.default.exclude]");
    ...
    assertValue(value, new File(basedir, "config"), "[**/*.config.include]",
        "[**/*.config.exclude]");
  }
  ...
  public void testInvalidIncludesExcludesConfiguration() throws Exception {
    ...
    builder(basedir) //
        .withConfigurationXml(
            "<resources>" + "<includes><include>**/*.config.include</include></includes>"
                + "<excludes><exclude>**/*.config.exclude</exclude></excludes>" + "</resources>") //
        .build(_TestData.class, "resources");
  }
  ...
  private void assertValue(GeneratedResourcesDirectoryValue value, File file, String includes,
      String excludes) {
