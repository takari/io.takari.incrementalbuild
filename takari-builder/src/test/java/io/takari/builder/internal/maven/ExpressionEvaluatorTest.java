...
public class ExpressionEvaluatorTest {
  ...
  public void testOutputDirectory() throws Exception {
    verifySimpleExpression("${project.build.outputDirectory}", project.getBuild().getOutputDirectory());
  }
  
  @Test
  public void testTestOutputDirectory() throws Exception {
    verifySimpleExpression("${project.build.testOutputDirectory}", project.getBuild().getTestOutputDirectory());
  }
