...
public class DependencyResourcesInputTest {
    ...
    File newJarArtifact(String... entries) throws IOException {
        return JarBuilder.create(temp.newFile().getCanonicalFile())
                .withEntries(entries)
                .build();
    }
    ...
    URL newResource(String name, String content) throws IOException {
        ...
        return ArtifactResourceURLStreamHandler.newURL(
                artifact, name, file.toURI().toURL());
    }
    ...
    public void testSpecificDependency() throws Exception {
        ...
        List<URL> value =
                (List<URL>) builder.build(_ListURLData.class, "resources").value();
    ...
    public void testCollectionDependencyResources() throws Exception {
        ...
        TestInputBuilder builder = builder() //
                ...
                .withDependency("g:b", dependencyB);

        @SuppressWarnings("unchecked")
        List<IArtifactResources> list = (List<IArtifactResources>)
                builder //
    ...
    public void testDependencyWithoutMatchingResources() throws Exception {
        ...
        TestInputBuilder builder = builder() //
                .withConfigurationXml("<resources>" + "<dependency>g:a</dependency>" + "<dependency>g:b</dependency>"
                        + "<include>a.txt</include>" + "</resources>")
                .withDependency("g:a", dependencyA)
                .withDependency("g:b", dependencyB);
        ...
        assertThat(list)
                .hasSize(1) //
                .extracting(r -> r.artifact().getArtifactId())
                .element(0)
                .isEqualTo("a");
    }
    ...
    public void testArtifactResources() throws Exception {
        ...
        IArtifactResources resources = (IArtifactResources)
                builder() //
                        .withDependency("g:a", dependencyA) //
    ...
    public void testArrayResources() throws Exception {
        ...
        URL[] urls = (URL[])
                builder() //
                        .withDependencies(dependency.getAbsolutePath())
                        .build(_ArrayResourceData.class, "resources") //
                        .value();
