...
public class InputDirectoryTest {
    ...
    static InputDirectoryValue newInputDirectoryFiles(Path location, String includes, String excludes) {
        return new InputDirectoryValue(
                File.class,
                location,
    ...
    static class _CompileSourceRoots {
        ...
        @InputDirectory(
                filesRequired = true,
                value = {"/bad", TEST_SOURCE_ROOTS_EXPR},
                includes = "**/*")
    ...
    public void testCompileSourceRoots() throws Exception {
        ...
        assertEquals(
                ...
                ((InputDirectoryValue) input.configuration.get(0))
                        .location
                        .toRealPath()
                        .toString());
    }
