...
public class CompositeInputTest {
    ...
    static CompositeValue newCompositeInput(String n1, String v1, String n2, String v2) throws Exception {
    ...
    public void testComplexListParameter() throws Exception {
        ...
        assertEquals("entry-1", ((StringValue) getMember(composite1, _Composite.class, "string")).configuration);
        assertFiles(
                directory1.files(), //
    ...
    public void testPrimitiveMemberComposite() throws Exception {
        ...
        _PrimitiveMemberComposite parameter = (_PrimitiveMemberComposite)
                builder() //
                        .withConfigurationXml("<parameter><string>string</string></parameter>") //
                        .build(_PrimitiveMemberData.class, "parameter")
                        .value();
    ...
    public void testIllegalAnnotationDefaultValue() throws Exception {
        builder() //
                .withConfigurationXml("<defaultValue><string>s</string><directory>.</directory></defaultValue>") //
    ...
    public void testPrivateMember() throws Exception {
        _PrivateMemberComposite parameter = (_PrivateMemberComposite)
                builder() //
                        .withConfigurationXml("<parameter><privateMember>value</privateMember></parameter>") //
                        .build(_PrivateMemberCompositeData.class, "parameter")
                        .value();
