...
public class BuilderMojoGeneratorTest {
  ...
  public void testUnrelatedClass() throws Exception {
      ...
      JavaFileObject unrelatedClass = JavaFileObjects.forSourceLines(
          "test.UnrelatedClass",
          "package test;",
          "public class UnrelatedClass implements java.io.Serializable {}"
      );
      ...
      assertAbout(javaSources())
              .that(Arrays.asList(unrelatedClass, builderClass))
              .processedWith(newMojoGenerator())
              .compilesWithoutError();
  }
  ...
  public void testOnlyTopLevelParamsAggregated() throws Exception {
      ...
      JavaFileObject generatedClass = JavaFileObjects.forSourceLines(
          "test.TestClass$GeneratedMojo$test_builder",
          "package test;", 
          "" + 
          ...
          "",
          "  @Parameter",
          "  PlexusConfiguration myInner;",
          "",
          "  public TestClass$GeneratedMojo$test_builder() {",
  ...
  public void testExtendsClass() throws Exception {
      ...
      JavaFileObject abstractClass = JavaFileObjects.forSourceLines(
          "test.AbstractClass",
          "package test;",
          "",
          "import io.takari.builder.*;",
      ...
      assertAbout(javaSources())
              .that(Arrays.asList(abstractClass, testClass))
              .processedWith(newMojoGenerator())
              .compilesWithoutError()
              .and().generatesSources(generatedClass);
  }
  ...
  public void testDuplicateInheritedParameterName() throws Exception {
      ...
      assertAbout(javaSources())
              ...
              .processedWith(newMojoGenerator())
              .failsToCompile()
              .withErrorContaining("Builder parameter 'parameter' duplicates parameter defined in test.AbstractClass");
  }
  ...
  public void testAllParameterAnnotations() throws Exception {
    ...
    JavaFileObject generatedClass = JavaFileObjects.forSourceLines(
        ...
        "",
        "  @Parameter",
        "  PlexusConfiguration inputDirectory;",
        "",
        "  @Parameter",
        "  PlexusConfiguration inputDirectoryFiles;",
        "",
        "  @Parameter",
        "  PlexusConfiguration inputFile;",
        "",
        "  @Parameter",
        "  PlexusConfiguration outputDirectory;",
        "",
        "  @Parameter",
        "  PlexusConfiguration outputFile;",
        "",
        "  @Parameter",
        "  PlexusConfiguration generatedSourcesDirectory;",
        "",
        "  @Parameter",
        "  PlexusConfiguration dependencyResources;",
        "",
        "  @Parameter",
  ...
  public void testPrimitiveParameter() throws Exception {
    JavaFileObject validClass = JavaFileObjects.forSourceLines(
        "test.TestClass",
        "package test;",
        "import io.takari.builder.*;",
        "public class TestClass {",
    ...
    JavaFileObject invalidClass = JavaFileObjects.forSourceLines(
        "test.TestClass",
        "package test;",
        "import io.takari.builder.*;",
        "public class TestClass {",
  ...
  public void testResolutionScopeWithComposite() throws Exception {
    JavaFileObject testClass = JavaFileObjects.forSourceLines(
        ...
        "",
        "public class TestClass {",
        "  @Parameter ExampleComposite compositeWithResolutionScope;",
        "",
        "  @Builder(name=\"test-builder\")",
        "  public void execute() {}",
        "",
    ...
    JavaFileObject generatedClass = JavaFileObjects.forSourceLines(
        ...
        "public class TestClass$GeneratedMojo$test_builder extends AbstractIncrementalMojo {",
        "  @Parameter",
        "  PlexusConfiguration compositeWithResolutionScope;",
        "",
        "  public TestClass$GeneratedMojo$test_builder() {",
        "    super(TestClass.class);",
        "  }",
