...
public interface Workspace {
    ...
    public default boolean isOptimizedBuildEnabled() {
        return false;
    }

    public default boolean hasProjectDependenciesChanged() {
        return true;
    }

    public default boolean hasDelta(Set<String> resources) {
        return true;
    }
}
